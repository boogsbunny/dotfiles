...
(exwm-input-set-key (kbd "s-D") #'kill-current-buffer)
...
(boogs/exwm-global-set-key "s-p" #'boogs/password-store-copy-async)
(boogs/exwm-global-set-key "s-P" #'boogs/password-store-otp-copy-async)
